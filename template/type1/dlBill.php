...
<div id="main">
	<div id="contents">
		...
		<div class="rightbox">
			...
			<p id="billdate">
			<input type="text" name="year"  value="<?=$date['y']?>" id="year"  >年　
...
?>
			...
			〒<input type="text" name="post1" value="<?=$company['1']?>"  maxlength=3 id="company_post1" >-
				...
				<input type="text" name="address2" value="<?=$company[ '4' ]?>" id="company_address2" style="width:250px;"><br />
				<input type="text" name="company" value="<?=$company[ '0' ]?>" id="company_name" >
...
?>
	...
	<input type="hidden" name="download_status" value="<?=$download_status?>">
	</p>

...
if($five == "anq"){
	...
	if($_REQUEST[ 'type' ] == "sub"){
		...
		echo mb_convert_encoding(",回答14(1)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答14(2)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答14(3)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答14(4)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答14(5)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答14(6)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答14(7)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答14(8)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答14(9)","SJIS","UTF-8");



		echo mb_convert_encoding(",回答15(1)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(2)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(3)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(4)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(5)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(6)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(7)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(8)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(9)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(10)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(11)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(12)","SJIS","UTF-8");
		echo mb_convert_encoding(",回答15(13)","SJIS","UTF-8");



		echo mb_convert_encoding(",回答16","SJIS","UTF-8");
		echo mb_convert_encoding(",回答17","SJIS","UTF-8");
		echo mb_convert_encoding(",回答18","SJIS","UTF-8");

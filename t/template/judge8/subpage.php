	...
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&type=<?=$_REQUEST[ 'type' ]?>" method="POST" name="form1">
        ...
        <table class="table table-bordered" style="width:100%;">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row">5</th>
                    <td><?=$bossname?>さんがチームのメンバー個人に対してフィードバックをすること　※たとえば「Ａさんに１回、Ｂさんに３回」の場合は合計で「４」と回答</td>
        ...
        <div class="col-md-12">
            ...
            <table class="table table-bordered">
                <tr class="bg-primary text-center" style="color:white;vertical-align:middle;">
                    <th rowspan="2" style="width:20px !important;"></th>
                    <th  rowspan="2" style="width:400px;">設問</th>
                ...
                <tr class="bg-primary text-center" style="color:white;vertical-align:middle;">
                    <?php foreach($ans[$q] as $key=>$val):?>
                    <th style="-ms-writing-mode: tb-rl;text-orientation: upright;writing-mode: vertical-rl;text-align:left;" ><?=$val?></th>
                    <?php endforeach;?>
                </tr>
                <?php 
                    $num = 1;
                ...
                ?>
                    <tr>
                        ...
                        <?php foreach($ans[$q] as $key=>$val):
                            ...
                            ?>
                        <td class="text-center" style="vertical-align:middle;"><input type="radio" name="ans[<?=$value[ 'key' ]?>]" value="<?=$key?>" <?=$chk?> /></td>
                        <?php 
                            endforeach;
                        ?>
                    </tr>

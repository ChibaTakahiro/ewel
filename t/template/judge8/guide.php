...
?>
	<form action="<?=D_URL_TEST?>test/<?=$first?>/?k=<?=$_REQUEST[ 'k' ]?>&type=<?=$_REQUEST[ 'type' ]?>" method="POST">
		...
		<p>このたびはお忙しい中、アンケートに協力くださり、誠にありがとうございます。
</p>
		...
		<p style="margin-top:20px;">
		ご回答は、社外のアンケートシステムに保存され、個人情報を含まないデータとして研究者に提供されます。社内の方がデータにアクセスできません。<br />
		...
		<ol>
			<li>アンケート項目は約90問です（予想所要時間15分程度）。あなたのチームの基本情報、フィードバックの仕方、および、チームで最も頻繁に接触するメンバーの行動や仕事に対する態度について伺います。
			</li>
			<li>
			...
			<li>
			ご回答は研究以外の目的では使用しません。ご回答の保管および分析は、研究代表者である繁桝江里、共同研究者である山口裕幸のみが行います。
			</li>
			<li>

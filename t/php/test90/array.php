...
$array_question[1] = "研修前の調査で、「メンバーの中であなたが業務上で最も頻繁に接する人」として選んでいただいた部下を、下記の中からお選びください。
<br />
<p style='color:red'>
...
$array_question[2] = "チームのメンバーと以下のような形で話すことは、月に何回くらいありますか。オンラインで話す場合も含めて、半角整数値で入力してください
";
...
$line[$q][$i][ 'key' ] = "98";
$array_question[$q] = "
「チームのメンバーに対するフィードバックの仕方」について、研修内容を実践することを促した要因、または、妨げた要因はどのようなものでしたか。思いつくことを何でも書いてください。あなた自身の変化でも、それによって生じたメンバーの変化でもどちらでもかまいません。【以後も含め、記述欄には400字以内で書いてください。】
";
...
$line[$q][$i][ 'key' ] = "99";
$array_question[$q] = "
「チームのメンバーに対するフィードバック、および、チームメンバーとのコミュニケーション全般」について、研修後の変化として思いつくことを何でも書いてください。あなた自身のことでもメンバーのことでもどちらでもかまいません。
";
